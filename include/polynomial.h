...
namespace syo {
    ...
    private:
        ...
        friend const Polynomial operator+(Polynomial const& lhs, Polynomial const& rhs);
        friend const Polynomial operator*(Polynomial const& lhs, Polynomial const& rhs);
        friend const Polynomial operator/(Polynomial const& lhs, Polynomial const& rhs);
        friend const Polynomial operator-(Polynomial const& rhs);
    ...
    const Polynomial operator/(Polynomial const& lhs, Polynomial const& rhs);
    const Polynomial operator%(Polynomial const& lhs, Polynomial const& rhs);
    const Polynomial pow(Polynomial const& base, int exponent);
